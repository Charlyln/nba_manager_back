...
const putResignPlayers = require('../middlewares/putResignPlayers')
const putUpdateStatsBeg = require('../middlewares/putUpdateStatsBeg')
const putRookies = require('../middlewares/putRookies')
